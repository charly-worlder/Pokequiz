...
- [ ] **AC-7** — Angenommen eine Runde ist beendet, wenn der Nutzer zum Ergebnis weiterklickt, dann sieht er die erreichte Serie, die benötigte Zeit, „Nochmal spielen" als Primär-Aktion und „Zur Bestenliste" als sekundäre Aktion.
...
- [ ] **AC-21** — Angenommen ein Nutzer ist angemeldet, wenn er eine beliebige Seite der App öffnet, dann sieht er dieselbe Kopfzeile mit der Wortmarke (Ball-Motiv plus „Pokémon QUIZ"), dem Zugang zur Bestenliste und dem Nutzer-Chip mit Initiale und Trainername, aus dem heraus er sich abmelden kann.
...
- [ ] „Zur Bestenliste" (AC-7) zeigt bis zur Fertigstellung von PROJ-3 auf eine Seite, die es noch nicht gibt. Reihenfolge beim Bauen beachten oder den Link bis dahin ausblenden.
