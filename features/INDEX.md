...
- **Verantwortlicher ist Worlder.** Impressum und Datenschutzerklärung tragen **Platzhaltertext**, weil die App vorerst nicht live geht — siehe Deploy-Blocker. **✅ Seit dem 2026-09-10 existieren beide Seiten** (`src/app/privacy/page.tsx`, `src/app/imprint/page.tsx`), öffentlich ohne Anmeldung, mit einem auffälligen Hinweis ganz oben und gelb markierten Leerstellen im Text. Der QA-Lauf 4 hatte ihr Fehlen gefunden: Bis dahin lieferten beide eine 404, und **PROJ-4 EC-9 und EC-14 stützen sich darauf, dass die Datenschutzerklärung ihre Grenzen benennt** — dieses Dokument gab es nicht. Es gibt es jetzt, und es benennt beide Grenzen ausdrücklich (Sicherungskopien, Betriebsprotokoll des Anmeldedienstes). Die drei Schalter für tote Links sind damit umgelegt: `LEGAL_PAGES` in der Fußzeile, `PRIVACY_PAGE_EXISTS` in der Registrierung und der E2E-Stolperdraht in `tests/PROJ-2-access-guard.spec.ts` — Letzterer wurde beim Umlegen von selbst rot, wie er sollte.
...
| PROJ-4 | **Impressum und Datenschutzerklärung tragen nur Platzhaltertext** — bewusste Entscheidung vom 2026-09-09, weil die App vorerst nicht live geht (Verantwortlicher ist Worlder, die Anschrift bleibt ungenannt). Vor einem Livegang **zwingend** durch echte Angaben zu ersetzen: Ein unvollständiges Impressum ist nach DDG abmahnfähig, und eine Datenschutzerklärung mit Platzhaltern erfüllt Art. 13 DSGVO nicht.<br>**Seit dem 2026-09-10 existieren beide Seiten** und markieren jede Leerstelle sichtbar (gelb, plus ein Hinweis ganz oben). **Auszufüllen sind acht Stellen in der Datenschutzerklärung** (Anschrift, Kontakt-Adresse, drei Aufbewahrungsfristen — Hoster-Logs, Sicherungskopien, Betriebsprotokoll des Anmeldedienstes —, Hosting-Anbieter, SMTP-Anbieter, zuständige Aufsichtsbehörde) **und zehn im Impressum** (Anschrift, Vertretung, Rechtsform, Registereintrag, USt-IdNr., E-Mail, Telefon, inhaltlich Verantwortlicher nach § 18 Abs. 2 MStV). Die drei Fristen hängen an Hosting-Anbieter und Supabase-Tarif und stehen erst beim Deploy fest | beim Deploy, **zwingend** |
