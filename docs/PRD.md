...
- **E-Mail-Versand ist eine Startvoraussetzung, keine Ausbaustufe.** Supabases eingebauter Mailversand stellt ausschließlich an Adressen zu, die im Team des Projekts stehen — alle anderen werden mit „Email address not authorized" abgelehnt —, ist auf **2 Nachrichten pro Stunde** begrenzt und laut Supabase-Dokumentation ausdrücklich nicht für den Produktivbetrieb gedacht. Da es bewusst keine E-Mail-Bestätigung gibt, ist der Passwort-Reset der einzige Weg zurück ins Konto; ohne eigenen SMTP-Dienst funktioniert er für echte Spieler **gar nicht**. Nötig sind deshalb: ein SMTP-Anbieter (Resend oder Brevo haben taugliche kostenlose Kontingente) **und eine eigene Absender-Domain**, weil praktisch jeder Anbieter ohne verifizierte Domain nur an die eigene Adresse des Kontoinhabers zustellt. Erst mit eigenem SMTP schaltet Supabase außerdem die E-Mail-Vorlagen im Free Tier frei — davon hängt der geräteübergreifende Reset ab (PROJ-1, EC-7). **Stand 2026-09-04: keine Domain vorhanden, damit offen.**
